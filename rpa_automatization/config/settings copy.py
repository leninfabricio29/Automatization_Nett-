...
class Settings(BaseSettings):
    ...
    # Login Settings
    login_url: str = Field(default="https://erp.nettplus.net/web/login", alias="LOGIN_URL")
    login_username: str = Field(default="proyectos@nettplus.net", alias="LOGIN_USERNAME")
    login_password: str = Field(default="Server011NCS", alias="LOGIN_PASSWORD")
